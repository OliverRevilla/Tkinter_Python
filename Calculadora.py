...
#Entrada
e_texto = Entry(ventana, font = "Calibri 24")
e_texto.grid(row = 0, column = 0, columnspan = 4, padx = 5, pady = 5)

#Funcionalidad
def click_boton(valor):
    global i
    #insertar texto en caja de texto
...
#Borrar
def Borrar():
    e_texto.delete(0,END) #Borra desde el índice cero hasta el final
    i = 0 
...
def Calcular():
    ...
    i = 0 # Volver a cero el índice si queremos insertar más números
